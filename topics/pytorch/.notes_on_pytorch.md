...
- Note that replacing `torch.nn.LSTM` with `torch.nn.GRU` in the code below achieves a loss of 0.00196 in 15.9220s, compared to 0.00599 in 18.8894s with an LSTM
